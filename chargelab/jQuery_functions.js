...
$(document).ready(function () {
    ...
    $('input[name="countrybtn"]').change(function () {
        ...
        if (selectedCountry === "United States") {
            ...
            $appReceived.append('<option value="Payter US via Chargelab" selected>Payter US via Chargelab</option>');
            $leadSource.append('<option value="Payter US via Chargelab" selected>Payter US via Chargelab</option>');
            $("#price_plan").text("Flat Rate 4.25 % + 10¢");
            ...
            $appReceived.append('<option value="Payter Canada via Chargelab" selected>Payter Canada via Chargelab</option>');
            $leadSource.append('<option value="Payter Canada via Chargelab" selected>Payter Canada via Chargelab</option>');
