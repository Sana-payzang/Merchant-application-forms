...
$(document).ready(function () {
    ...
    $('input[name="countrybtn"]').change(function () {
        ...
        if (selectedCountry === "United States") {
            ...
            $appReceived.append('<option value="Payter US via Free2Move - Stellantis" selected>Payter US via Free2Move - Stellantis</option>');
            $leadSource.append('<option value="Payter US via Free2Move - Stellantis" selected>Payter US via Free2Move - Stellantis</option>');
            $("#price_plan").text("Flat Rate 5.25 % + 60¢");
            ...
            $appReceived.append('<option value="Payter Canada via Free2Move - Stellantis" selected>Payter Canada via Free2Move - Stellantis</option>');
            $leadSource.append('<option value="Payter Canada via Free2Move - Stellantis" selected>Payter Canada via Free2Move - Stellantis</option>');
            $("#price_plan").text("Flat Rate 5.25 % + 60¢");
            $(".pricing__container").show();
        }
    ...
    $(".next-btn").click(function (e) {
        ...
        if (formIndex === 2) {
            ...
            var mndFileds = new Array('match_Company', 'match_Email', 'match_Phone', 'match_Website', 'match_Street', 'match_City', 'match_State', 'match_Zip_Code', 'match_LEADCF2', 'match_LEADCF81', 'match_LEADCF5', 'match_LEADCF6', 'match_LEADCF13', 'match_LEADCF14', 'match_LEADCF15', 'match_LEADCF16', 'match_LEADCF17', 'match_LEADCF18');
            var fldLangVal = new Array('Company Name', 'Email', 'Phone', 'Website', 'Street', 'City', 'State / Province', 'Zip Code', 'EIN/TIN/Tax ID', 'Date of Incorporation', 'Business Type', 'Ownership Type', 'Bank Name', 'Bank Account Number', 'Confirm Bank Account Number', 'Bank Routing Number', 'Confirm Bank Routing Number', 'Estimated Annual Revenue', 'Highest Ticket Size', 'Average Ticket Size');
